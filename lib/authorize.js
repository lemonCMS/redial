(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "./propNameAuth"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("./propNameAuth"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.propNameAuth);
    global.authorize = mod.exports;
  }
})(this, function (_exports, _propNameAuth) {
  "use strict";
  ...
  var _default = function _default(name, components, locals) {
    ...
    .map(function (component) {
      return {
        component: component,
        hooks: component[_propNameAuth.default]
      };
