...
var _triggerWait2 = _interopRequireDefault(_triggerWait);
...
var _authorizeWait2 = _interopRequireDefault(_authorizeWait);

exports['default'] = {
  provideHooks: _provideHooks2['default'],
  trigger: _trigger2['default'],
  triggerWait: _triggerWait2['default'],
  authorize: _authorize2['default'],
  authorizeWait: _authorizeWait2['default']
};
